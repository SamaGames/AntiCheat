...
import net.samagames.samaritan.cheats.antixray.internal.ChunkQueue;
import net.samagames.samaritan.cheats.antixray.obfuscation.Calculations;
import net.samagames.samaritan.cheats.antixray.utils.OrebfuscatorAsyncQueue;
...
public class ChunkProcessingThread extends Thread {
    private static OrebfuscatorAsyncQueue<ChunkProcessingOrder> queue = new OrebfuscatorAsyncQueue<ChunkProcessingOrder>();
