...
import net.samagames.samaritan.cheats.xray.obfuscation.MinecraftBlock;
...
public class ChunkQueue extends LinkedList<ChunkCoordIntPair> {
    ...
    public void FinishedProcessing(PacketChunkDataBulk packet) {
        if (lastPacket != null) {
            ReflectionHelper.setPrivateField(lastPacket, "c", packet.getChunksMap());
